...
class GeneralKnowledgeStudyTab extends StatefulWidget {
  final bool resumeFromLast;

  const GeneralKnowledgeStudyTab({Key? key, this.resumeFromLast = false})
      : super(key: key);

  @override
  State<GeneralKnowledgeStudyTab> createState() =>
      _GeneralKnowledgeStudyTabState();
}

class _GeneralKnowledgeStudyTabState extends State<GeneralKnowledgeStudyTab> {
  ...
  Future<void> _saveProgress(int page) async {
    final prefs = await SharedPreferences.getInstance();
    await prefs.setInt('progress_questionsbank_study', page);
  }
  ...
  Widget _buildQuestionPage(List<dynamic> questions, int index) {
    ...
    final correctId = _getCorrectAnswerIdForGeneral(questionId);
