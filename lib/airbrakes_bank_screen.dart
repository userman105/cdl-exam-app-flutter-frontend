...
class _AirbrakesQuestionsTabState extends State<AirbrakesQuestionsTab> {
  ...
  Widget _buildQuestionPage(
    ...
    final selected = examState.selectedAnswers[qid];
      ...
      children: [
        Expanded(
          child: Padding(
            ...
            child: _buildArabicQuestionCard(question, answers, qid, selected),
          ),
        ),
                  ...
                  children: [
                    ...
                    ...answers.map((ans) {
                      return AnswerOption(
                        ...
                        correctAnswerId: _getCorrectAnswerId(qid),
                        onTap: !_showAnswer
                            ? () => context
                            .read<ExamCubit>()
  ...
  Future<void> _handleShowAnswer(List<dynamic> questions, int index) async {
    ...
    final prefs = await SharedPreferences.getInstance();
    await prefs.setInt('airbrakes_progress_questionsbank', _currentPage);
  ...
  void _speakEnglish(Map<String, dynamic> question, List<dynamic> answers) {
    TTSService.showSnackBar(context, 'TTS', 'Commencing speech...',
        ContentType.help);
    final text =
